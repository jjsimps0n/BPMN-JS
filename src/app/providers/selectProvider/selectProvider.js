 ...
 */
function SelectProvider(propertiesPanel, translate) {
...
SelectProvider.$inject = [ 'propertiesPanel', 'translate' ];
...
export default {
  __init__: [ 'selectProvider' ],
  selectProvider: [ 'type', SelectProvider ]
};